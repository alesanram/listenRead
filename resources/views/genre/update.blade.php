        ...
        <div class="col-md-8 order-md-1" style="padding-left:10%">
            <form action="{{route("genre.update")}}" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" value="{{$genre->name}}" class="form-control" name="name" id="nombre" placeholder="Nombre"/>
                    </div>
                </div>
                <div class="form-group row"><br></div>
                <div class="form-group row">
                    <div class="col-sm-6">
                        <button type="submit" class="btn btn-primary">Modificar Genero</button>
                    </div>
                    <div class="col-sm-6">
